      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="text-center text-gray-500 mt-8">
            ...
            <p className="text-sm">
              Ask questions based on our conversation history, or get help with any topic.
            </p>
          </div>
        )}
                        ...
                        <div key={idx} className="text-xs bg-gray-50 p-2 rounded">
                          ...
                          <div className="text-gray-600 mt-1">
                            ...
                            <div className="mt-1 text-gray-500">
                              &ldquo;{source.content.length > 50 ? source.content.substring(0, 50) + '...' : source.content}&rdquo;
                            </div>
                          </div>
                        </div>
                      ))}
      ...
      <div className="p-4 border-t bg-white">
        <form onSubmit={handleSubmit} className="flex space-x-2">
          <input
            ...
            placeholder="Ask questions about our conversation history or get help with any topic..."
