...
import { Settings, Copy, Volume2, Play, AudioWaveform, ChevronDown, MessageSquare, Plus, Speaker, Trash2, Mic, Loader2, Upload, FileText, PieChart, BarChart3, Database, Zap } from 'lucide-react'
      ...
      <div className="flex-1 flex flex-col bg-card/80 backdrop-blur-sm border rounded-xl shadow-sm">
        <div className="px-6 py-6 border-b">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2">
              <FileUpload className="h-8 px-2 sm:px-3 btn-hover-lift focus-glow" />
            </div>
          </div>
